...
public class MainActivity extends AppCompatActivity {
    ...
    private void insertDosen(){
        Call<DefaultResult> call = dataDosenService.insertDosen("Dendy","011","Yogyakarta",
                "dendy@dendy.com","SKUYLIVING","dendy.jpg","72160033");
    ...
    private void deleteDosen(){
        Call<DefaultResult> call = dataDosenService.deleteDosen("18","72160033");
        call.enqueue(new Callback<DefaultResult>() {
            @Override
            public void onResponse(Call<DefaultResult> call, Response<DefaultResult> response) {
                System.out.println(response.body().getStatus());
    ...
    private void insertDosenWithFoto(){
        ...
        Call<DefaultResult> call = dataDosenService.insertDosenWithFoto("Dendy","72160033","Yogyakarta",
                "dendy@dendy.com","SKUYLIVING",imageToSend,"72160033");
        call.enqueue(new Callback<DefaultResult>() {
            @Override
            public void onResponse(Call<DefaultResult> call, Response<DefaultResult> response) {
                System.out.println(response.body().getStatus());
